...
export const DEFAULT_GAS_TOKEN = 'BKPSDM_TRANSFORMERS_2026_SECURE_TOKEN';

export const APP_CONFIG = {
  INSTANSI: 'Pemerintah Daerah Kabupaten Majalengka',
  OPD: 'BKPSDM Kab. Majalengka',
  PROGRAM: 'Program Transformers 2026',
  JUDUL_SURVEI: 'Survei Peminatan & Potensi Usaha ASN Pra-Pensiun'
};
